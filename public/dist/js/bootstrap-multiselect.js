    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return this.nonSelectedText + ' <i class="fa fa-angle-down"></i>';
                }
                else if (options.length == $('option', $(select)).length) {
                    return this.allSelectedText + ' <i class="fa fa-angle-down"></i>';
                }
                    ...
                    return selected.substr(0, selected.length - 2) + ' <i class="fa fa-angle-down"></i>';
                }
            },
            /**
            ...
            templates: {
                button: '<button type="button" class="multiselect dropdown-toggle rq-dropdown" data-toggle="dropdown"></button>',
                ul: '<ul class="multiselect-container dropdown-menu rq-dropdown-menu"></ul>',
